...
class TestVerdict(unittest.TestCase):
    ...
    def test_verification_that_did_not_run_is_not_a_finding(self):
        result = _result(CLEAN, "", error="LMStudioError: server stopped")
        self.assertTrue(result.semantic_ok)
        self.assertTrue(result.ok)
        self.assertIn("did not run", result.verdict_detail)
