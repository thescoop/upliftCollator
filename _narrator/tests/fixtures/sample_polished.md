...
**Panel Membership:** A minimum enhancement of 15% is claimed as the fee earner (Jane Doe) is a member of the Resolution Accredited Specialist Panel and Law Society Children Panel (and work relates to children), and the work undertaken falls within the scope of this accreditation. This is a guaranteed minimum enhancement.
...
## Level Determination (Justifying the % - Spec Para 6.15 / CAG Section 12.5 & 12.9)

Once the threshold test is met, the level of enhancement is justified by the following factors:

**Degree of Responsibility accepted by the fee earner (CAG 12.9(a)):**

*   **Complex drafting:** Complex drafting of the full position statement, the Scott Schedule, and the section 7 response was undertaken without recourse to Counsel, all of which were settled in advance of the case management hearing.

**Care, speed, and economy (CAG 12.9(b)):**

*   **Care and adapted techniques:** Particular care was taken in dealing with a vulnerable client who has diagnosed PTSD and a learning disability assessed at the borderline range. To accommodate the client, the fee earner conducted instructions across six shorter attendances, utilised plain-language summaries, and brought an intermediary to the FHDRA.
